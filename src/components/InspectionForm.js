...
import { Form, Button, Row, Col, Alert, Card, Modal, OverlayTrigger, Tooltip } from 'react-bootstrap';
...
const InspectionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.createInspection(processedData);
      navigate('/inspections');
    } catch (error) {
      console.error('Error creating inspection:', error);
      setError('Failed to create inspection. Please check your inputs and try again.');
    } finally {
  ...
  return (
    <div className="inspection-form">
      <h2 className="mb-4">Add New Inspection</h2>
            ...
            <Row>
              ...
              <FieldLabel field="eifs_installed_year" />
                <Form.Select
                  ...
                  onChange={(e) => setFormData({ ...formData, eifs_installed_year: e.target.value })}
                >
